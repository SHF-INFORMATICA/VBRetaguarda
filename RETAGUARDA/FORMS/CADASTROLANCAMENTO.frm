...
Begin VB.Form frmCADRECEBVENDA 
   BackColor       =   &H000000C0&
   ...
   EndProperty
   Icon            =   "CADASTROLANCAMENTO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   7725
   ScaleWidth      =   10950
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":5C12
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":6066
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":6382
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":67D6
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":6C2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":6F4A
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CADASTROLANCAMENTO.frx":739E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.StatusBar barRodape 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel2 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Picture         =   "CADASTROLANCAMENTO.frx":76BE
         EndProperty
      EndProperty
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
   ...
   End
End
Attribute VB_Name = "frmCADRECEBVENDA"
...
'set aqui nao precia lar, update direto
         ...
         If Not TabCABECA.EOF Then
            If TabCABECA!Status = 2 Then
               ...
               SQL = SQL & " , valor_recebido = " & tpMOEDA(VALOR_RECEBIDO_N)
               SQL = SQL & " , valor_desconto = " & tpMOEDA(VALOR_DESCONTO_N)
               SQL = SQL & ", TIPOVENDA_ID = " & cmbTipoVendaAUX.Text
               SQL = SQL & " , valor_total = " & tpMOEDA(txtVendaSemDesconto.Text)
               SQL = SQL & " , cliente_id = " & CLIENTE_ID_N
...
'On Error GoTo ERRO_TRATA
   ...
   SQL = SQL & " PEDIDO.VENDEDOR_ID, PEDIDO.TIPOVENDA_ID, PEDIDO.CGCCPF, PEDIDO.DT_REQ, "
...
Exit Sub
ERRO_TRATA:
   TRATA_ERROS Err.Description & "-" & SQL3, Me.Name, "GRAVA_CARTAO_PEDIDO"
End Sub
