...
Begin VB.Form frmLojECFLeituraMemoriaData 
   ...
   End
End
Attribute VB_Name = "frmLojECFLeituraMemoriaData"
...
'On Error GoTo ERRO_TRATA
   ...
   CRITERIO = Month(Format(Date, "dd/mm/yyyy"))
   CRITERIO = Trim(CRITERIO)
   If Len(CRITERIO) <= 1 Then _
      CRITERIO = "0" & CRITERIO
   txtDataInicial.PromptInclude = False
      txtDataInicial.Text = "01/" & CRITERIO & "/" & Year(Format(Date, "dd/mm/yyyy"))
   txtDataInicial.PromptInclude = True
...
'On Error GoTo ERRO_TRATA
   ...
   txtDataInicial.PromptInclude = True
   CRITERIO = "01" & Right(txtDataInicial.Text, 7)
   txtDataInicial.PromptInclude = False
   txtDataInicial.Text = CRITERIO
   txtDataInicial.PromptInclude = True
