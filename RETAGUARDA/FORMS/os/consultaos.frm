      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":5C12
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":703A
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":80C9
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":941B
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":AC2D
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":C007
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":D317
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "consultaos.frx":E422
               Key             =   ""
            EndProperty
         EndProperty
      End
...
'On Error GoTo ERRO_TRATA
   ...
   SQL = "SELECT OS.OS_ID, OS.EQUIPAMENTO_ID, OS.DT_OS, OS.TIPO_OS, OS.SITUACAO_OS, "
   SQL = SQL & " OS.KM, OS.CT_ID, OS.DT_FECHA, EQUIPAMENTO.DT_CAD, EQUIPAMENTO.DESCRICAO as DescricaoEquipamento, "
   SQL = SQL & " EQUIPAMENTO.IDENTIFICACAO, EQUIPAMENTO.PESSOA_ID, EQUIPAMENTO.COR_ID,"
   SQL = SQL & " EQUIPAMENTO.MARCA_ID, EQUIPAMENTO.TIPO_EQP, EQUIPAMENTO.ANO, EQUIPAMENTO.modelo, "
   SQL = SQL & " VEICULO.VEICULO_ID, VEICULO.COMBUSTIVEL_ID, VEICULO.PLACA, VEICULO.DESCRICAO AS DescricaoVeiculo, "
   SQL = SQL & " VEICULO.MOTOR, VEICULO.CHASSI, PESSOA.CNPJCPF, PESSOA.DESCRICAO AS NomeCliente, PESSOA.SITUACAO "
   SQL = SQL & " FROM OS "
   SQL = SQL & " INNER JOIN EQUIPAMENTO "
   SQL = SQL & " ON OS.EQUIPAMENTO_ID = EQUIPAMENTO.EQUIPAMENTO_ID "
   SQL = SQL & " INNER JOIN PESSOA "
   SQL = SQL & " ON EQUIPAMENTO.PESSOA_ID = PESSOA.PESSOA_ID "
   SQL = SQL & " INNER JOIN VEICULO "
   SQL = SQL & " ON EQUIPAMENTO.EQUIPAMENTO_ID = VEICULO.EQUIPAMENTO_ID"
   ...
   If PESSOA_ID_N > 0 Then _
      SQL = SQL & " and EQUIPAMENTO.pessoa_id = " & PESSOA_ID_N
   ...
   If IsDate(txtDtIni.Text) And IsDate(txtDtFim.Text) Then
      If optDtAbertura.Value = True Then
         SQL = SQL & " and dt_os >= " & DMA(txtDtIni.Text)
         SQL = SQL & " and dt_os <= " & DMA(txtDtFim.Text)
      End If
      If optDtFechamento.Value = True Then
         SQL = SQL & " and dt_fecha >= " & DMA(txtDtIni.Text)
         SQL = SQL & " and dt_fecha <= " & DMA(txtDtFim.Text)
      End If
   End If
...
'====================================
      ...
      NOME_A = "" & Trim(TabTemp.Fields("nomecliente").Value)
...
'======================
         ...
         While Not TabServico.EOF
            ...
            DtFecha_D = 0
            If Not IsNull(TabServico.Fields("dt_fecha").Value) Then _
               DtFecha_D = TabServico.Fields("dt_fecha").Value
...
'====================================
      txtCNPJCPF.PromptInclude = False
      'NOME_A = "" & Trim(TabTemp.Fields("nome_cliente").Value)
