   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":A544
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":A998
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":ACB4
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":B108
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":B55C
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":B87C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSVEICULO.frx":BCD0
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'On Error GoTo ERRO_TRATA
   ...
   If Not TabTemp.EOF Then
      ...
      OSEQUIPAMENTO_ID_N = 0 & TabTemp.Fields("EQUIPAMENTO_ID").Value
      txtOS.Text = PEDIDO_ID_N
      txtDtOS.PromptInclude = False
...
'On Error GoTo ERRO_TRATA
   ...
   If INDR_OS_VEICULO = False Then
      ...
      If Not TabCABECA.EOF Then
         SQL = "update OS set "
            SQL = SQL & " EQUIPAMENTO_ID = " & OSEQUIPAMENTO_ID_N         'EQUIPAMENTO_ID
...
'On Error GoTo ERRO_TRATA
   ...
   If Not TabUser.EOF Then
      ...
      If Not TabVend.EOF Then
         ...
         cmbVendedorAUX.Text = "" & VENDEDOR_ID_N
      End If
      If TabVend.State = 1 Then _
         TabVend.Close
   End If
