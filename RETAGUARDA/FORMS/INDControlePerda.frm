...
Begin VB.Form frmProducaoRegistroPerdaCadastro 
   Caption         =   "Registro de Perda Produção"
   ClientHeight    =   7620
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   11385
   ...
   EndProperty
   Icon            =   "INDControlePerda.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   7620
   ScaleWidth      =   11385
   ...
   Begin VB.Frame FraSeq 
      ...
      Begin VB.CommandButton cmdConsProd 
         ...
         Height          =   350
         Left            =   4065
         Picture         =   "INDControlePerda.frx":5C12
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   405
      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":6614
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":77AE
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":883D
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":97F2
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":A8FD
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":BA53
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":BEA5
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":DD1C
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":F3D2
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "INDControlePerda.frx":113B4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmProducaoRegistroPerdaCadastro"
...
'On Error GoTo ERRO_TRATA
   ...
   Select Case Button.key
      Case "consultar"
         frmProducaoRegistroPerdaConsulta.Show 1
...
'On Error GoTo ERRO_TRATA
   ...
   If Trim(txtLOTE.Text) = "" Then _
      NUMR_LOTE_N = MAX_ID("CONTROLEPERDA_ID", "CONTROLEPERDA", "", "", "", "")
...
End Sub
'============================subrotinas
Private Sub EXCLUIR_ITEM(CONTROLEPERDA_ID_N As Long, SEQ_ID_N As Long)
'On Error GoTo ERRO_TRATA

   If Trim(CONTROLEPERDA_ID_N) > 0 And Trim(SEQ_ID_N) > 0 Then
      ...
      If RESPOSTA = vbYes Then
         ...
         SQL = SQL & " Where CONTROLEPERDA_id = " & CONTROLEPERDA_ID_N
...
'On Error GoTo ERRO_TRATA
   ...
   SQL = "select CONTROLEPERDAITEM.SEQ_ID as Seq, PRODUTO.CODG_PRODUTO as Codg, "
   SQL = SQL & " PRODUTO.DESCRICAO as Descrição, CONTROLEPERDAITEM.QTDE, CONTROLEPERDAITEM.valor as Valor,"
   SQL = SQL & " FAMILIAPRODUTO.DESCRICAO AS DescFamilia, FAMILIAPRODUTO.PRODUCAO, "
   SQL = SQL & " CONTROLEPERDAITEM.PRODUTO_ID, PRODUTO.FAMILIAPRODUTO_ID, "
   SQL = SQL & " FAMILIAPRODUTO.CODG_FAMILIA, CONTROLEPERDAITEM.CONTROLEPERDA_ID, "
   SQL = SQL & " PRODUTO.PESO_LIQUIDO"
   SQL = SQL & " from CONTROLEPERDAITEM "
   ...
   SQL = SQL & " INNER JOIN CONTROLEPERDA "
   SQL = SQL & " ON CONTROLEPERDAITEM.CONTROLEPERDA_ID = CONTROLEPERDA.CONTROLEPERDA_ID"

   SQL = SQL & " where CONTROLEPERDA.CONTROLEPERDA_id = " & txtLOTE.Text
...
'On Error GoTo ERRO_TRATA
   ...
   If Trim(txtLOTE.Text) <> "" Then
      NUMR_LOTE_N = txtLOTE.Text
      Else: NUMR_LOTE_N = InputBox(SQL3, "Informe número de CONTROLEPERDA a ser impressa ")
   End If

   If NUMR_LOTE_N > 0 Then
      FORMULA_REL = "{controleperda.estabelecimento_id} = " & ESTABELECIMENTO_ID_N
      FORMULA_REL = FORMULA_REL & " and {controleperda.controleperda_id} = " & NUMR_LOTE_N
   End If
...
'On Error GoTo ERRO_TRATA
   ...
   If EXISTE_OBJ_BANCO("RETAGUARDA", "CONTROLEPERDA", "") = False Then
      SQL = "CREATE TABLE [dbo].[CONTROLEPERDA]("
      SQL = SQL & " [CONTROLEPERDA_ID] [bigint] NOT NULL,"
      ...
      SQL = SQL & " CONSTRAINT [PK_CONTROLEPERDA] PRIMARY KEY CLUSTERED([CONTROLEPERDA_ID] Asc)"
      ...
      SQL = " ALTER TABLE [dbo].[CONTROLEPERDA]  WITH CHECK ADD  CONSTRAINT [FK_CONTROLEPERDA_ESTABELECIMENTO] FOREIGN KEY([ESTABELECIMENTO_ID])"
      SQL = SQL & " References [dbo].[ESTABELECIMENTO]([ESTABELECIMENTO_ID])"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDA] CHECK CONSTRAINT [FK_CONTROLEPERDA_ESTABELECIMENTO]"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDA]  WITH CHECK ADD  CONSTRAINT [FK_CONTROLEPERDA_USUARIO] FOREIGN KEY([USUARIO_ID])"
      SQL = SQL & " References [dbo].[USUARIO]([USUARIO_ID])"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDA] CHECK CONSTRAINT [FK_CONTROLEPERDA_USUARIO]"
      CONECTA_RETAGUARDA.Execute SQL
      Else
         If EXISTE_CAMPO_TABELA("RETAGUARDA", "TURNO_ID", "CONTROLEPERDA") = False Then _
            CONECTA_RETAGUARDA.Execute "ALTER TABLE CONTROLEPERDA ADD TURNO_ID INT"
   End If
   If EXISTE_OBJ_BANCO("RETAGUARDA", "CONTROLEPERDAITEM", "") = False Then
      SQL = "CREATE TABLE [dbo].[CONTROLEPERDAITEM]("
      SQL = SQL & " [CONTROLEPERDA_ID] [bigint] NOT NULL,"
      ...
      SQL = " ALTER TABLE [dbo].[CONTROLEPERDAITEM]  WITH CHECK ADD  CONSTRAINT [FK_CONTROLEPERDAITEM_CONTROLEPERDA] FOREIGN KEY([CONTROLEPERDA_ID])"
      SQL = SQL & " References [dbo].[CONTROLEPERDA]([CONTROLEPERDA_ID])"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDAITEM] CHECK CONSTRAINT [FK_CONTROLEPERDAITEM_CONTROLEPERDA]"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDAITEM]  WITH CHECK ADD  CONSTRAINT [FK_CONTROLEPERDAITEM_PRODUTO] FOREIGN KEY([PRODUTO_ID])"
      SQL = SQL & " References [dbo].[PRODUTO]([PRODUTO_ID])"
      CONECTA_RETAGUARDA.Execute SQL

      SQL = " ALTER TABLE [dbo].[CONTROLEPERDAITEM] CHECK CONSTRAINT [FK_CONTROLEPERDAITEM_PRODUTO]"
      CONECTA_RETAGUARDA.Execute SQL
      Else
         If EXISTE_CAMPO_TABELA("RETAGUARDA", "VALOR", "CONTROLEPERDAITEM") = False Then _
            CONECTA_RETAGUARDA.Execute "ALTER TABLE CONTROLEPERDAITEM ADD VALOR FLOAT "
   End If
...
Sub PROCURA_REGISTRO(NUMR_CONTROLEPERDA_ID_N As Long)
'On Error GoTo ERRO_TRATA
   ...
   SQL = "select * from CONTROLEPERDA "
   SQL = SQL & " where CONTROLEPERDA_id = " & NUMR_CONTROLEPERDA_ID_N
...
Sub GRAVA_REGISTRO(NUMR_CONTROLEPERDA_ID_N As Long, Dt_Fehca As String, SIT_ATUAL_LOTE As String, TURNO_ID_N As String)
'On Error GoTo ERRO_TRATA
   ...
   If NUMR_CONTROLEPERDA_ID_N <= 0 Then _
      Exit Sub
   ...
   If Not TabCabeca.EOF Then
      ...
      End If
      Else
         SQL = "insert into CONTROLEPERDA "
            SQL = SQL & "(CONTROLEPERDA_ID,ESTABELECIMENTO_ID,USUARIO_ID,DT_REGISTRO,Status,TURNO_ID)"
         SQL = SQL & " values("

            SQL = SQL & NUMR_CONTROLEPERDA_ID_N       'CONTROLEPERDA_ID
...
'=========================
   ...
   SQL = "select * from CONTROLEPERDAITEM "
   SQL = SQL & " where CONTROLEPERDA_id = " & NUMR_CONTROLEPERDA_ID_N
   ...
   If Not TabItem.EOF Then
      ...
      End If
      Else
         SQL = "insert into CONTROLEPERDAITEM "
            SQL = SQL & "(CONTROLEPERDA_ID,SEQ_ID,PRODUTO_ID,QTDE,VALOR)"
         SQL = SQL & " values("
...
Sub GERA_SEQUENCIA()
   ...
   NUMR_SEQ_N = MAX_ID("SEQ_ID", "CONTROLEPERDAITEM", "CONTROLEPERDA_ID", txtLOTE.Text, "", "")
...
'On Error GoTo ERRO_TRATA
   ...
   End If
   If Trim(txtLOTE.Text) = "" Then
      MsgBox "Falta numero CONTROLEPERDA."
      Exit Sub
   End If
'=====================
   If Trim(txtSeq.Text) = "" Then
      SEQ_ID_N = 0 & MAX_ID("seq_id", "CONTROLEPERDAITEM", "CONTROLEPERDA_id", Trim(txtLOTE.Text), "", "")
      Else
