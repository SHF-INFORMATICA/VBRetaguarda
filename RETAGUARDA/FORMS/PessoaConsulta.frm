      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "PessoaConsulta.frx":5C12
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "PessoaConsulta.frx":6DAC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "PessoaConsulta.frx":7E3B
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "PessoaConsulta.frx":8F46
               Key             =   ""
            EndProperty
         EndProperty
      End
...
'On Error GoTo ERRO_TRATA
   ...
   PESSOA_ID_N = LISTA.SelectedItem.ListSubItems.item(6)
   Unload Me
...
'On Error GoTo ERRO_TRATA
   ...
   If Trim(TIPO_PESSOA_CADASTRO) = "EQUIPE" Then
      SQL = "select PESSOA.* from PESSOA "
      SQL = SQL & " INNER JOIN EQUIPE "
      SQL = SQL & " ON PESSOA.PESSOA_ID = EQUIPE.PESSOA_ID "
   End If
   ...
   If Trim(TIPO_PESSOA_CADASTRO) = "EQUIPE" Or Trim(TIPO_PESSOA_CADASTRO) = "CLIENTE" Or Trim(TIPO_PESSOA_CADASTRO) = "FORNECEDOR" Then _
...
'MsgBox SQL
   ...
   While Not TabTemp.EOF
      ...
      item.SubItems(1) = "" & TRAZ_IE(TabTemp.Fields("pessoa_id").Value)
      item.SubItems(2) = "" & Trim(TabTemp.Fields("descricao").Value)
      item.SubItems(3) = "" & Trim(TabTemp!RAZAO)
      item.SubItems(4) = "" & TabTemp!DATA_CAD
      item.SubItems(5) = "" & TabTemp!SITUACAO
      item.SubItems(6) = "" & TabTemp.Fields("pessoa_id").Value
      TabTemp.MoveNext
   Wend
   TabTemp.Close
...
'On Error GoTo ERRO_TRATA
   ...
   End If
   If Trim(TIPO_PESSOA_CADASTRO) = "EQUIPE" Then
      Me.Caption = "Consulta Equipe Venda"
      lblNome.Visible = True
      txtNome.Visible = True
      lblCNPJCPF.Visible = True
      txtCNPJCPF.Visible = True
