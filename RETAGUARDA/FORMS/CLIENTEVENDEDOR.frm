      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":5C12
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":6DAC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":7E3B
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":8DF0
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":9EFB
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "CLIENTEVENDEDOR.frx":BEDD
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub Form_Load()
   If TIPO_PESSOA_CADASTRO = "CLIENTE" Then _
      Me.Caption = "Clientes / Vendas"
   If TIPO_PESSOA_CADASTRO = "ESTABELECIMENTO" Then _
...
'On Error GoTo ERRO_TRATA
   ...
   If TIPO_PESSOA_CADASTRO = "CLIENTE" Then
      ...
      Nome_Relatorio = "rel_Cli_Venda.rpt.rpt"
      If chkImp.Value = 1 Then
         If ESCOLHE_IMPRESSORA(NOME_BANCO_DADOS) = True Then _
            frmRELATORIO10.Show 1
         Else: frmRELATORIO10.Show 1
      End If
   End If
   If TIPO_PESSOA_CADASTRO = "ESTABELECIMENTO" Then
      FORMULA_REL = "{VENDEDOR.status} = 'A'"
      If Trim(cmbEstabAUX.Text) <> "" Then _
         FORMULA_REL = FORMULA_REL & " and {ESTABELECIMENTO.estabelecimento_id} = " & Trim(cmbEstabAUX.Text)

      If Trim(cmbVendAux.Text) <> "" Then _
         FORMULA_REL = FORMULA_REL & " and {VENDEDOR.vendedor_id} = " & Trim(cmbVendAux.Text)
