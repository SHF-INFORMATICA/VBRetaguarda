...
Begin VB.Form frmTransfConsulta 
   ...
   Begin VB.CommandButton cmdConsProd 
      ...
      Height          =   350
      Left            =   3105
      Picture         =   "TransfConsulta.frx":5C12
      Style           =   1  'Graphical
      TabIndex        =   15
      Top             =   1800
      Width           =   405
      ...
      Begin MSComctlLib.ImageList ImageList2 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":6614
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":7A3C
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":8ACB
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":9C65
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":BADC
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "TransfConsulta.frx":D7E6
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmTransfConsulta"
...
'On Error GoTo ERRO_TRATA
   ...
   If Not TabProduto.EOF Then
      txtDesc.Text = "" & Trim(TabProduto.Fields("descricao").Value)
...
txtProduto.Text = "" & Int(Mid(CODIGO_BARRAS, CasaInicioCodgProdBarra_N, TamanhoCodgProdBarra_N))
...
'On Error GoTo ERRO_TRATA
   ...
   If Trim(txtDesc.Text) <> "" Then
      CRITERIO = Chr$(39) & txtDesc.Text & "%" & Chr(39)
      SQL = SQL & " and descricao like " & CRITERIO
   End If
...
Sub MONTA_REL()
   ...
   If Trim(txtDesc.Text) <> "" Then
      CRITERIO = Chr$(39) & txtDesc.Text & "%" & Chr(39)
      FORMULA_REL = FORMULA_REL & " and {PRODUTO.descricao} like " & CRITERIO
   End If
