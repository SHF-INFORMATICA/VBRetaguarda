...
'   Line Input #f, sLine
   ...
   'If Trim(NOME_BANCO_DADOS) = "" Then _
      NOME_BANCO_DADOS = Trim(InputBox("Informe BANCO DE DADOS PARA CONEXÃO", "SHF INFORMÁTICA", NOME_BANCO_DADOS))
   ...
   If TabCAIXA.EOF Then
      ...
      Else
         ...
         If Date >= DATA_INI Then
            SqL2 = "" & InputBox("Solicitar contra senha para liberação do sistema.", "Informe Chave para liberação.")
            ...
            If Date >= DATA_INI Then
               MsgBox "Chave informada inválida, Solicitar Contra Senha ao suporte da SHF INFORMÁTICA. " & SQL3
...
'On Error GoTo ERRO_TRATA
   ...
   If ValidaInscricaoEstadual = 1 Then
       MsgBox "Inscricao Inválida para a Uf Informada . " & strRetorno, vbExclamation, "SHFSYS"
   ElseIf ValidaInscricaoEstadual = 2 Then
       MsgBox "Cliente com parametros de inscricao estadual inválidos ." & strRetorno, vbExclamation, "SHFSYS"
   End If
...
Public Function Checagem_Definição_Campo_Tabela(strTabela As String, _
...
'==================================================
   ...
   If ExisteTabela("RETAGUARDA", "PRODUTO", "") = True Then
      If ExisteCampo("RETAGUARDA", "QTDE", "PRODUTO") = True Then
         Alteração_Definição_Campo_Tabela "QTDE", "NUMERIC(18,3)", "PRODUTO"
         Alteração_Definição_Campo_Tabela "qtde_retido", "NUMERIC(18,3)", "PRODUTO"
      End If
   End If
   ...
   If ExisteTabela("RETAGUARDA", "PEDIDO", "") = True Then
      If ExisteCampo("RETAGUARDA", "NUMR_CUPOM", "PEDIDO") = False Then
         ...
         CONECTA_RETAGUARDA.Execute SQL
         Else: Alteração_Definição_Campo_Tabela "NUMR_CUPOM", "NVARCHAR(20)", "PEDIDO"
      End If
   End If
'==============================================
...
Public Sub SP_PESSOA(TIPO_A As String, _
   ...
   If Trim(TIPO_A) = "C" Then 'consulta
      ...
      Else
         If Trim(TIPO_A) = "" Then
            MsgBox "Informar tipo de instrução para procedimento."
            Exit Sub
         End If
         If IsNull(ID_N) Then
...
'On Error GoTo ERRO_TRATA
   ...
   If ExisteCampo("RETAGUARDA", "PESO_BRUTO", "PRODUTO") = False Then
      ...
      Else: Alteração_Definição_Campo_Tabela "PESO_BRUTO", "NUMERIC(18,3)", "PRODUTO"
   End If
...
'============================
Public Sub IMPRIMIR_ORDEM_SERVIÇO_VEICULO(NUMR_OS_N As Long)
'On Error GoTo ERRO_TRATA
...
Exit Sub
ERRO_TRATA:
   TRATA_ERROS Err.Description, "mdlOS", "IMPRIMIR_ORDEM_SERVIÇO_VEICULO"
End Sub

Public Sub IMPRIMIR_ORDEM_SERVIÇO(NUMR_OS_N As Long, TIPO_REL As String)
'On Error GoTo ERRO_TRATA
   ...
   If Trim(TIPO_REL) = "SERVIÇO" Then _
...
Exit Sub
ERRO_TRATA:
   TRATA_ERROS Err.Description, "mdlOS", "IMPRIMIR_ORDEM_SERVIÇO"
End Sub
