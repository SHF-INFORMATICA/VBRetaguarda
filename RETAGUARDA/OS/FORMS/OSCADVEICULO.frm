...
Begin VB.Form frmOSVEICULOCADASTRO 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "OSCADVEICULO.frx":5C12
      ...
      Tab(0).Control(13)=   "txtCNPJCPF"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "txtDtIni"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "cmbComb"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "cmbCor"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "txtMotor"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "txtDescricao"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "cmbTIPO"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "txtMODELO"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "txtANO"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "txtNome"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "txtCHASSI"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "cmbCombAUX"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "cmbCorAUX"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cmbTipoAUX"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "cmbMarca"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "cmbMarcaAUX"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "cmdConsultaPlaca"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "cmdConsultaCliente"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "cmdCadCliente"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "txtFrota"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txtPlaca"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).ControlCount=   34
      TabCaption(1)   =   "C&onsulta"
      TabPicture(1)   =   "OSCADVEICULO.frx":5C2E
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":9178
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":95CC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":98E8
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":9D3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":A190
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":A4B0
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCADVEICULO.frx":A904
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'On Error GoTo ERRO_TRATA
   ...
   If TabTemp.EOF Then
      ...
      SQL = SQL & "(EQUIPAMENTO_ID,DT_CAD,DESCRICAO,IDENTIFICACAO,PESSOA_ID,COR_ID,MARCA_ID,TIPO_EQP,ANO,modelo)"
      SQL = SQL & " values("
      ...
      SQL = SQL & "(VEICULO_ID,EQUIPAMENTO_ID,COMBUSTIVEL_ID,PLACA,DESCRICAO,MOTOR,CHASSI,NUMR_FROTA)"
      SQL = SQL & " values("
