...
Begin VB.Form frmOSVEICULOCONSULTA 
   ...
   ClientTop       =   330
   ClientWidth     =   9375
   Icon            =   "OSCONSULTAVEICULO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":5C12
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":6066
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":6382
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":67D6
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":6C2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":6F4A
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "OSCONSULTAVEICULO.frx":739E
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
   Call CentralizaJanela(frmOSVEICULOCONSULTA)
...
'On Error GoTo ERRO_TRATA
   ...
   While Not TabTemp.EOF
      ...
      Set Item = LISTACHASSI.ListItems.Add(, "seq." & TabTemp.Fields("equipamento_id").Value, TabTemp!PLACA)

      Item.SubItems(1) = "" & TabTemp!CHASSI
      Item.SubItems(2) = "" & Trim(TabTemp.Fields("nome_cliente").Value)
      Item.SubItems(3) = "" & TabTemp!Ano
      Item.SubItems(4) = "" & TabTemp!modelo
      Item.SubItems(5) = "" & TRAZ_DESCRITOR("A", TabTemp!TIPO_EQP)
...
Exit Sub
ERRO_TRATA:
   TRATA_ERROS Err.Description, Me.Name, "Sub SETA_GRID_CHASSI"
End Sub
